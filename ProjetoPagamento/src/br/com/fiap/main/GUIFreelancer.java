...
public class GUIFreelancer extends JPanel{
    ...
    private void inicializarComponentes() {
    	...
    	setLayout(null); //definir posicionamento na tela
        ...
        lbNome.setBounds(10, 30, 120, 25); //(x, y, largura, altura)
    	...
    	btCalcularSalario.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
                    ...
                    JOptionPane.showMessageDialog(null, e2.getMessage(), //e2 é um objeto novo
